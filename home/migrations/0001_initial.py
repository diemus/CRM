# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-01-17 07:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.Branch', verbose_name='校区')),
            ],
            options={
                'verbose_name': '班级',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.PositiveSmallIntegerField(choices=[(0, '转介绍'), (1, 'QQ群'), (2, '官网'), (3, '百度推广'), (4, '51CTO'), (5, '知乎'), (6, '市场推广')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.Customer')),
                ('enrolled_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.ClassList', verbose_name='所报班级')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menus', models.ManyToManyField(blank=True, to='home.Menu')),
            ],
            options={
